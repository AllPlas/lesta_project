...
// context creation, etc.) (IMPORTANT: SDL 3.0.0 is NOT YET RELEASED. IT IS POSSIBLE THAT ITS
// SPECS/API WILL CHANGE BEFORE RELEASE)
...
//  2023-02-23: Accept SDL_GetPerformanceCounter() not returning a monotonically increasing value.
//  (#6189, #6114, #3644) 2023-02-07: Forked "imgui_impl_sdl2" into "imgui_impl_sdl3". Removed
...
static void ImGui_ImplSDL3_SetClipboardText(void*, const char* text) { SDL_SetClipboardText(text); }
